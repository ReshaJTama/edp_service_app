...
class CpbListMenuStaffPage extends StatefulWidget {
  const CpbListMenuStaffPage({Key key}) : super(key: key);

  @override
  _CpbListMenuStaffPageState createState() => _CpbListMenuStaffPageState();
}
...
class _CpbListMenuStaffPageState extends State<CpbListMenuStaffPage> {
            ...
            child: ListView(
              ...
              children: <Widget>[
                Card(
                  ...
                  child: Center(
                    child: ListTile(
                      title: Text("Selamat Datang " + _nama ),
